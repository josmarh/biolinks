            ...
            <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                        ...
                        <font-awesome-icon icon="fa-solid fa-circle-exclamation" class="h-6 w-6 text-red-600" aria-hidden="true" />
                    </div>
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900 capitalize">
                            Delete {{from}}
                        </DialogTitle>
                        <div class="mt-2">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" 
                        ...
                        bg-red-600 px-4 py-2 text-base font-medium 
                        ...
                        @click="confirm" :disabled="isDisabled">
                        Delete
                    ...
                    <button type="button" 
                        ...
                        focus:ring-0 focus:ring-indigo-500 focus:ring-offset-2 
...
const open = ref(props.showDelete)
let isDisabled = ref(props.isDisabled)

watch(() => props.showDelete, (newVal, oldVal) => {
    open.value = newVal
})
