...
let thankYouMsg = ref(props.data)

watch(() => props.data, (newVal, oldVal) => {
    thankYouMsg.value = newVal
})

watch(thankYouMsg, (newVal, oldVal) => {
    emit('update', thankYouMsg.value)
})
</script>
