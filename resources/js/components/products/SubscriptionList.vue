            ...
            <tbody>
                <tr v-for="item in data" :key="item.id"
                    ...
                    <td class="px-6 py-4 truncate">
                        <span class="font-medium">Membership Plan:</span> {{ item.description }}
                    </td>
                    <td class="px-6 py-4">
...
const theaders = ['email','product','status','date','total']
...
const getForPage = (ev,link) => {
    ...
    productStore.dispatch('paginateSubscriptions', link.url);
}
</script>
