<template>
    <modal-layout title="Add a Clubhouse Block" :show-form="open" @close-modal="closeModal">
        <form @submit.prevent="newClubhouse">
            <p class="text-md text-gray-600 font-normal mt-8 tracking-tight">
                Add a title and a description with the Clubhouse Block.
            </p>
            ...
            <link-field 
                :data="model.sectionFields.clubhouseLink"
                :required="isRequired"
                label="Link"
                placeholder="https://www.joinclubhouse.com/"
                @update="updateLink"/>
...
function updateLink(data) {
    model.value.sectionFields.clubhouseLink = data;
}
