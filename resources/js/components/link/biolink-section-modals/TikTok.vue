<template>
    <modal-layout title="Add a TikTok video" :show-form="open" @close-modal="closeModal">
        <form @submit.prevent="newTiktok">
            ...
            <link-field 
                :data="model.sectionFields.tiktokUrl" 
                :required="linkRequired"
                label="TikTok Video URL"
                placeholder="https://www.tiktok.com/@charlidamelio/video/6808693617306111237"
                @update="updateLink" 
            />
...
function updateLink(data) {
    model.value.sectionFields.tiktokUrl = data
}
