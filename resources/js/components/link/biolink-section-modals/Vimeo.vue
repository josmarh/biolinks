<template>
    <modal-layout title="Add a Vimeo video" :show-form="open" @close-modal="closeModal">
        <form @submit.prevent="newVimeo">
            <p class="text-md text-gray-600 font-normal mt-8 tracking-tight">
                Paste in your Vimeo URL and we will show it as a video on your profile.
            </p>
            <link-field 
