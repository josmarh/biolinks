<template>
    <modal-layout title="Add a Soundcloud song" :show-form="open" @close-modal="closeModal">
        <form @submit.prevent="newSoundcloud">
            ...
            <link-field 
                :data="model.sectionFields.soundcloudUrl" 
                :required="linkRequired"
                label="Soundcloud URL"
                placeholder="http://soundcloud.com/octobersveryown/duppy-freestyle"
                @update="updateLink" 
            />
...
function updateLink(data) {
    model.value.sectionFields.soundcloudUrl = data
}

function newSoundcloud() {
