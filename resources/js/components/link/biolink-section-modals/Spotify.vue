<template>
    <modal-layout title="Add a Spotify Song / Album" :show-form="open" @close-modal="closeModal">
        <form @submit.prevent="newSpotify">
            ...
            <link-field 
                :data="model.sectionFields.spotifyUrl" 
...
function updateLink(data) {
    model.value.sectionFields.spotifyUrl = data
}
