<div class="mt-6 mb-4 lg:mx-64">
    <div class="flex flex-wrap gap-8 justify-center px-12">
        ...
        <a href="mailto:{{$socials->email}}">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="{{$socials->buttonColor}}" class="mt-0.5 w-8 h-8">
        ...
        @endif
        @if($socials->whatsapp)
        <a href="https://api.whatsapp.com/send?phone={{$socials->whatsapp}}" target="_blank">
        ...
        @endif
        @if($socials->fbMessager)
        <a href="{{$socials->fbMessager}}" target="_blank">
            <svg role="img" viewBox="0 0 24 24" class="mt-0.5 w-8 h-8" 
                xmlns="http://www.w3.org/2000/svg" fill="{{$socials->buttonColor}}">
        ...
        @endif
        @if($socials->spotify)
        <a href="social.socials.spotify" target="_blank">
            <svg role="img" class="mt-0.5 w-8 h-8" viewBox="0 0 24 24" 
                xmlns="http://www.w3.org/2000/svg" fill="{{$socials->buttonColor}}">
        ...
        @endif
        @if($socials->clubhouse)
        <a href="{{$socials->clubhouse}}" target="_blank">
            <svg role="img" class="mt-0.5 w-8 h-8" viewBox="0 0 24 24" 
                xmlns="http://www.w3.org/2000/svg" fill="{{$socials->buttonColor}}">
